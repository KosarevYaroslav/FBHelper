...
typedef void(^FBHelperCallback)(BOOL success, id result);
...
/**
 *  If not on the list in FBHelper method, this method can be used to make calls via the graph API GET
 *
...
/**
 *  If not on the list in FBHelper method, this method can be used to make calls via the graph API POST
 *
